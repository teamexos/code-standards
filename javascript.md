...
## Objects
  ...
  - [3.4](#es6-object-concise) Use property value shorthand. eslint: [`object-shorthand`](https://eslint.org/docs/rules/object-shorthand.html)
    ...
    ```javascript
    const odellBeckham = 'Odell Beckham';
...
## Testing
  ...
  - [30.1](#unit-testing) [EXOS Unit Testing Guide](https://github.com/teamexos/code-standards/blob/master/unit-testing.md)
  - [30.2](#integration-testing) [EXOS Integration Testing Guide](https://github.com/teamexos/code-standards/blob/master/integration-testing.md)
